...
return [
    ...
    'connections' => [
        ...
        'mu_domicilios' => [
            'driver' => 'mysql',
            'host' => env('MU_DOMICILIOS_HOST', '127.0.0.1'),
            'port' => env('MU_DOMICILIOS_PORT', '3306'),
            'database' => env('MU_DOMICILIOS_DATABASE', 'forge'),
            'username' => env('MU_DOMICILIOS_USERNAME', 'forge'),
            'password' => env('MU_DOMICILIOS_PASSWORD', ''),

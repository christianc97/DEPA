...
class DomiciliosUsuariosController extends Controller {
    ...
    public function index() {
        ...
        if ($tienePermiso) {
            $domicilios_usuarios = DB::connection('mu_domicilios')->select('select e.id, e.mu_ref empresa_mu ,e.nombre nombre_empresa, u.mu_ref as usuario_mu, u.username, u.password_reset_token,  GROUP_CONCAT(p.ciudad) as ciudad  from user u

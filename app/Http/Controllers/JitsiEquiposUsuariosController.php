...
class JitsiEquiposUsuariosController extends Controller
{
    ...
    public function index() {
        ...
        if ($tienePermiso) {
            $jitsi_equipos = DB::connection('reportesmensajeros')->select('select e.id_equipos, ue.fecha_desasignacion, e.codigo, e.ext_jitsi, ue.users_id, u.nombre1, u.apellido1, GROUP_CONCAT("\n", e.codigo) AS nombres, e.area from equipos e

...
@section('titulo')
<h3 class="box-title">Puntos Domicilios Villavicencio</h3>
<div class="dropdown pull-right">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      ...
      <li role="presentation"><a role="menuitem" tabindex="-1" href="/puntosdomicilios/MapaSantaMarta">Santa Marta</a></li>
    </ul>
  </div>
@endsection
